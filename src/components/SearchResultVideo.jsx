...
const SearchResultVideo = ({ video }) => {
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className='flex md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4'>
        ...
        <div className='flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden'>
          ...
          <span className='empty:hidden text-sm line-clamp-1 md:line-clamp-2 text-white/[0.2] md:pr-24 md:my-4'>
